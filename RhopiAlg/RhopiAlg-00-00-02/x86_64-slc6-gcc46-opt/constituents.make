...
#cmt_local_tagfile = $(omega_tag).make
cmt_local_tagfile = $(bin)$(omega_tag).make
...
#cmt_local_tagfile_RhopiAlg = $(omega_tag)_RhopiAlg.make
cmt_local_tagfile_RhopiAlg = $(bin)$(omega_tag)_RhopiAlg.make
cmt_local_setup_RhopiAlg = $(bin)setup_RhopiAlg$$$$.make
cmt_final_setup_RhopiAlg = $(bin)setup_RhopiAlg.make
#cmt_final_setup_RhopiAlg = $(bin)omega_RhopiAlgsetup.make
...
#cmt_local_tagfile_RhopiAlg = $(omega_tag).make
cmt_local_tagfile_RhopiAlg = $(bin)$(omega_tag).make
cmt_final_setup_RhopiAlg = $(bin)setup.make
#cmt_final_setup_RhopiAlg = $(bin)omegasetup.make
cmt_local_RhopiAlg_makefile = $(bin)RhopiAlg.make
...
#cmt_local_tagfile_install_runtime = $(omega_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(omega_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)omega_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(omega_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(omega_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)omegasetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(omega_tag)_config.make
cmt_local_tagfile_config = $(bin)$(omega_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)omega_configsetup.make
...
#cmt_local_tagfile_config = $(omega_tag).make
cmt_local_tagfile_config = $(bin)$(omega_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)omegasetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(omega_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(omega_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)omega_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(omega_tag).make
cmt_local_tagfile_install_includes = $(bin)$(omega_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)omegasetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(omega_tag)_make.make
cmt_local_tagfile_make = $(bin)$(omega_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)omega_makesetup.make
...
#cmt_local_tagfile_make = $(omega_tag).make
cmt_local_tagfile_make = $(bin)$(omega_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)omegasetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(omega_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(omega_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)omega_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(omega_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(omega_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)omegasetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(omega_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(omega_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)omega_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(omega_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(omega_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)omegasetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(omega_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(omega_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)omega_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(omega_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(omega_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)omegasetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(omega_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(omega_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)omega_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(omega_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(omega_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)omegasetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(omega_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(omega_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)omega_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(omega_tag).make
cmt_local_tagfile_TestProject = $(bin)$(omega_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)omegasetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(omega_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(omega_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)omega_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(omega_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(omega_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)omegasetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(omega_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(omega_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)omega_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(omega_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(omega_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)omegasetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_omega_check_install_runtime = $(bin)setup_omega_check_install_runtime$$$$.make
...
omega_check_install_runtime_extratags = -tag_add=target_omega_check_install_runtime

#$(cmt_local_tagfile_omega_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_omega_check_install_runtime) ::
else
$(cmt_local_tagfile_omega_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_omega_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_omega_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(omega_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_omega_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_omega_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_omega_check_install_runtime) || \rm -f $(cmt_local_setup_omega_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_omega_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(omega_check_install_runtime_extratags) show setup >$(cmt_local_setup_omega_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_omega_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_omega_check_install_runtime) $(cmt_local_setup_omega_check_install_runtime); then \
	    \rm $(cmt_local_setup_omega_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_omega_check_install_runtime) $(cmt_final_setup_omega_check_install_runtime); fi
...
not_omega_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(omega_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
omega_check_install_runtimedirs :
	@if test ! -d $(bin)omega_check_install_runtime; then $(mkdir) -p $(bin)omega_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)omega_check_install_runtime
else
omega_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)omega_check_install_runtime
#
#$(cmt_local_omega_check_install_runtime_makefile) :: $(omega_check_install_runtime_dependencies) $(cmt_local_tagfile_omega_check_install_runtime) build_library_links dirs omega_check_install_runtimedirs
#else
#$(cmt_local_omega_check_install_runtime_makefile) :: $(omega_check_install_runtime_dependencies) $(cmt_local_tagfile_omega_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_omega_check_install_runtime_makefile) :: $(cmt_local_tagfile_omega_check_install_runtime)
#endif

ifdef cmt_omega_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_omega_check_install_runtime_makefile) : $(omega_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building omega_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(omega_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime
else
$(cmt_local_omega_check_install_runtime_makefile) : $(omega_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_omega_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_omega_check_install_runtime) ] || \
	  $(not_omega_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building omega_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(omega_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime; \
	  fi
endif
...
$(cmt_local_omega_check_install_runtime_makefile) : $(omega_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building omega_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)omega_check_install_runtime.in -tag=$(tags) $(omega_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime
else
$(cmt_local_omega_check_install_runtime_makefile) : $(omega_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)omega_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_omega_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_omega_check_install_runtime) ] || \
	  $(not_omega_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(omega_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime

omega_check_install_runtime :: $(omega_check_install_runtime_dependencies) $(cmt_local_omega_check_install_runtime_makefile) dirs omega_check_install_runtimedirs
	$(echo) "(constituents.make) Starting omega_check_install_runtime"
	@if test -f $(cmt_local_omega_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtime
	$(echo) "(constituents.make) omega_check_install_runtime done"

clean :: omega_check_install_runtimeclean

omega_check_install_runtimeclean :: $(omega_check_install_runtimeclean_dependencies) ##$(cmt_local_omega_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting omega_check_install_runtimeclean"
	@-if test -f $(cmt_local_omega_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) omega_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) omega_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_omega_check_install_runtime_makefile) $(bin)omega_check_install_runtime_dependencies.make

install :: omega_check_install_runtimeinstall

omega_check_install_runtimeinstall :: $(omega_check_install_runtime_dependencies) $(cmt_local_omega_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install omega_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install omega_check_install_runtime done"

uninstall : omega_check_install_runtimeuninstall

$(foreach d,$(omega_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += omega_check_install_runtimeuninstall))

omega_check_install_runtimeuninstall : $(omega_check_install_runtimeuninstall_dependencies) ##$(cmt_local_omega_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall omega_check_install_runtime"
	@if test -f $(cmt_local_omega_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_omega_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall omega_check_install_runtime done"

remove_library_links :: omega_check_install_runtimeuninstall
