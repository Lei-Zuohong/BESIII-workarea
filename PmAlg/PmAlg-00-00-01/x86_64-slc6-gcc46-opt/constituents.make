...
#cmt_local_tagfile = $(PmAlg_tag).make
cmt_local_tagfile = $(bin)$(PmAlg_tag).make
...
#cmt_local_tagfile_make = $(PmAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(PmAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)PmAlg_makesetup.make
...
#cmt_local_tagfile_make = $(PmAlg_tag).make
cmt_local_tagfile_make = $(bin)$(PmAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)PmAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(PmAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(PmAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)PmAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(PmAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(PmAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)PmAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(PmAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(PmAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)PmAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(PmAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(PmAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)PmAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(PmAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(PmAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)PmAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(PmAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(PmAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)PmAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(PmAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(PmAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)PmAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(PmAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(PmAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)PmAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(PmAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(PmAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)PmAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(PmAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(PmAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)PmAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(PmAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(PmAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)PmAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(PmAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(PmAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)PmAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(PmAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(PmAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)PmAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(PmAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(PmAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)PmAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_PmAlg_check_install_runtime = $(bin)setup_PmAlg_check_install_runtime$$$$.make
...
PmAlg_check_install_runtime_extratags = -tag_add=target_PmAlg_check_install_runtime

#$(cmt_local_tagfile_PmAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_PmAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_PmAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_PmAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_PmAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(PmAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_PmAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_PmAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_PmAlg_check_install_runtime) || \rm -f $(cmt_local_setup_PmAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_PmAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(PmAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_PmAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_PmAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_PmAlg_check_install_runtime) $(cmt_local_setup_PmAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_PmAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_PmAlg_check_install_runtime) $(cmt_final_setup_PmAlg_check_install_runtime); fi
...
not_PmAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(PmAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PmAlg_check_install_runtimedirs :
	@if test ! -d $(bin)PmAlg_check_install_runtime; then $(mkdir) -p $(bin)PmAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PmAlg_check_install_runtime
else
PmAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)PmAlg_check_install_runtime
#
#$(cmt_local_PmAlg_check_install_runtime_makefile) :: $(PmAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_PmAlg_check_install_runtime) build_library_links dirs PmAlg_check_install_runtimedirs
#else
#$(cmt_local_PmAlg_check_install_runtime_makefile) :: $(PmAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_PmAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_PmAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_PmAlg_check_install_runtime)
#endif

ifdef cmt_PmAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_PmAlg_check_install_runtime_makefile) : $(PmAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building PmAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(PmAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime
else
$(cmt_local_PmAlg_check_install_runtime_makefile) : $(PmAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PmAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_PmAlg_check_install_runtime) ] || \
	  $(not_PmAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PmAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(PmAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_PmAlg_check_install_runtime_makefile) : $(PmAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building PmAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)PmAlg_check_install_runtime.in -tag=$(tags) $(PmAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime
else
$(cmt_local_PmAlg_check_install_runtime_makefile) : $(PmAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)PmAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PmAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_PmAlg_check_install_runtime) ] || \
	  $(not_PmAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PmAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime

PmAlg_check_install_runtime :: $(PmAlg_check_install_runtime_dependencies) $(cmt_local_PmAlg_check_install_runtime_makefile) dirs PmAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting PmAlg_check_install_runtime"
	@if test -f $(cmt_local_PmAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtime
	$(echo) "(constituents.make) PmAlg_check_install_runtime done"

clean :: PmAlg_check_install_runtimeclean

PmAlg_check_install_runtimeclean :: $(PmAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_PmAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting PmAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_PmAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) PmAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) PmAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_PmAlg_check_install_runtime_makefile) $(bin)PmAlg_check_install_runtime_dependencies.make

install :: PmAlg_check_install_runtimeinstall

PmAlg_check_install_runtimeinstall :: $(PmAlg_check_install_runtime_dependencies) $(cmt_local_PmAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install PmAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install PmAlg_check_install_runtime done"

uninstall : PmAlg_check_install_runtimeuninstall

$(foreach d,$(PmAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += PmAlg_check_install_runtimeuninstall))

PmAlg_check_install_runtimeuninstall : $(PmAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_PmAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall PmAlg_check_install_runtime"
	@if test -f $(cmt_local_PmAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PmAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall PmAlg_check_install_runtime done"

remove_library_links :: PmAlg_check_install_runtimeuninstall
