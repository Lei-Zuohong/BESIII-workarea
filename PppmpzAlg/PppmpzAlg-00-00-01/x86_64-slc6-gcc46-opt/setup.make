...
use BesExternalArea BesExternalArea-00-00-22 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use GdmlManagement GdmlManagement-00-00-32 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
...
use MYSQL MYSQL-00-00-09 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
...
use BesCLHEP BesCLHEP-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use BesGeant4 BesGeant4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use GdmlToG4 GdmlToG4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
...
use BesFortranPolicy BesFortranPolicy-00-01-03  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
...
use BesROOT BesROOT-00-00-08 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use GdmlToRoot GdmlToRoot-00-00-14 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
...
use GaudiInterface GaudiInterface-01-03-07 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use BesCxxPolicy BesCxxPolicy-00-01-01  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use BesPolicy BesPolicy-01-05-05  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use BesTimerSvc BesTimerSvc-00-00-12 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use SimUtil SimUtil-00-00-37 Simulation/BOOST (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use ROOTGeo ROOTGeo-00-00-15 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use Identifier Identifier-00-02-15 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use G4Geo G4Geo-00-00-12 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use MucGeomSvc MucGeomSvc-00-02-25 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use EmcRecGeoSvc EmcRecGeoSvc-01-01-07 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use RelTable RelTable-00-00-02 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use DatabaseSvc DatabaseSvc-00-00-24 Database (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use facilities facilities-00-00-04 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use CalibData CalibData-00-01-09 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use xmlBase xmlBase-00-00-03 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use rdbModel rdbModel-00-01-01 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use calibUtil calibUtil-00-00-39 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use EventModel EventModel-01-05-33 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use McTruth McTruth-00-02-19 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use MagneticField MagneticField-00-01-38  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use MdcGeomSvc MdcGeomSvc-00-01-37 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use EvTimeEvent EvTimeEvent-00-00-08 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use DstEvent DstEvent-00-02-50-p01 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use ExtEvent ExtEvent-00-00-13 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use MucRecEvent MucRecEvent-00-02-52 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use EmcRecEventModel EmcRecEventModel-01-01-18 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use TofRecEvent TofRecEvent-00-02-14 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use MdcRecEvent MdcRecEvent-00-05-14 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use EvtRecEvent EvtRecEvent-00-01-05 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01)
use ParticleID ParticleID-00-04-55 Analysis (/besfs/users/leizh/besiii/workarea665)
use VertexFit VertexFit-00-02-75 Analysis (/besfs/users/leizh/besiii/workarea665)
----------> tags
...
----------> CMTPATH
# Add path /besfs/users/leizh/besiii/workarea665 from initialization
# Add path /cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/6.6.5.p01 from initialization
