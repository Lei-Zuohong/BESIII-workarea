...
#cmt_local_tagfile = $(OmegaAlg_tag).make
cmt_local_tagfile = $(bin)$(OmegaAlg_tag).make
...
#cmt_local_tagfile_make = $(OmegaAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(OmegaAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)OmegaAlg_makesetup.make
...
#cmt_local_tagfile_make = $(OmegaAlg_tag).make
cmt_local_tagfile_make = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)OmegaAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(OmegaAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(OmegaAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)OmegaAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(OmegaAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)OmegaAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(OmegaAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(OmegaAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)OmegaAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(OmegaAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)OmegaAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(OmegaAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(OmegaAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)OmegaAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(OmegaAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)OmegaAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(OmegaAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(OmegaAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)OmegaAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(OmegaAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)OmegaAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(OmegaAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(OmegaAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)OmegaAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(OmegaAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)OmegaAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(OmegaAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(OmegaAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)OmegaAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(OmegaAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)OmegaAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(OmegaAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(OmegaAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)OmegaAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(OmegaAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(OmegaAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)OmegaAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_OmegaAlg_check_install_runtime = $(bin)setup_OmegaAlg_check_install_runtime$$$$.make
...
OmegaAlg_check_install_runtime_extratags = -tag_add=target_OmegaAlg_check_install_runtime

#$(cmt_local_tagfile_OmegaAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_OmegaAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_OmegaAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_OmegaAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_OmegaAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_OmegaAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_OmegaAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_OmegaAlg_check_install_runtime) || \rm -f $(cmt_local_setup_OmegaAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_OmegaAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_OmegaAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_OmegaAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_OmegaAlg_check_install_runtime) $(cmt_local_setup_OmegaAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_OmegaAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_OmegaAlg_check_install_runtime) $(cmt_final_setup_OmegaAlg_check_install_runtime); fi
...
not_OmegaAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(OmegaAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
OmegaAlg_check_install_runtimedirs :
	@if test ! -d $(bin)OmegaAlg_check_install_runtime; then $(mkdir) -p $(bin)OmegaAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)OmegaAlg_check_install_runtime
else
OmegaAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)OmegaAlg_check_install_runtime
#
#$(cmt_local_OmegaAlg_check_install_runtime_makefile) :: $(OmegaAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_OmegaAlg_check_install_runtime) build_library_links dirs OmegaAlg_check_install_runtimedirs
#else
#$(cmt_local_OmegaAlg_check_install_runtime_makefile) :: $(OmegaAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_OmegaAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_OmegaAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_OmegaAlg_check_install_runtime)
#endif

ifdef cmt_OmegaAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_OmegaAlg_check_install_runtime_makefile) : $(OmegaAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building OmegaAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime
else
$(cmt_local_OmegaAlg_check_install_runtime_makefile) : $(OmegaAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_OmegaAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_OmegaAlg_check_install_runtime) ] || \
	  $(not_OmegaAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building OmegaAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_OmegaAlg_check_install_runtime_makefile) : $(OmegaAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building OmegaAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)OmegaAlg_check_install_runtime.in -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime
else
$(cmt_local_OmegaAlg_check_install_runtime_makefile) : $(OmegaAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)OmegaAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_OmegaAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_OmegaAlg_check_install_runtime) ] || \
	  $(not_OmegaAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(OmegaAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime

OmegaAlg_check_install_runtime :: $(OmegaAlg_check_install_runtime_dependencies) $(cmt_local_OmegaAlg_check_install_runtime_makefile) dirs OmegaAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting OmegaAlg_check_install_runtime"
	@if test -f $(cmt_local_OmegaAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtime
	$(echo) "(constituents.make) OmegaAlg_check_install_runtime done"

clean :: OmegaAlg_check_install_runtimeclean

OmegaAlg_check_install_runtimeclean :: $(OmegaAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_OmegaAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting OmegaAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_OmegaAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) OmegaAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) OmegaAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) $(bin)OmegaAlg_check_install_runtime_dependencies.make

install :: OmegaAlg_check_install_runtimeinstall

OmegaAlg_check_install_runtimeinstall :: $(OmegaAlg_check_install_runtime_dependencies) $(cmt_local_OmegaAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install OmegaAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install OmegaAlg_check_install_runtime done"

uninstall : OmegaAlg_check_install_runtimeuninstall

$(foreach d,$(OmegaAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += OmegaAlg_check_install_runtimeuninstall))

OmegaAlg_check_install_runtimeuninstall : $(OmegaAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_OmegaAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall OmegaAlg_check_install_runtime"
	@if test -f $(cmt_local_OmegaAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_OmegaAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall OmegaAlg_check_install_runtime done"

remove_library_links :: OmegaAlg_check_install_runtimeuninstall
